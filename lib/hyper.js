...
module.exports = function hyper(obj) {
  ...
  Object.keys(obj).forEach(function(key) {
    ...
    } else if (typeof dom[key] === 'undefined') {
...
HyperLinkDOM.prototype = {
   ...
   */
  open: function open() {
    console.log('GET', this.data.href);
  }
...
var HyperActionDOM = exports.HyperActionDOM = function HyperActionDOM(obj) {
  ...
  var self = this;
  Object.keys(this.data.input).forEach(function(key) {
...
HyperActionDOM.prototype = {
  ...
  submit: function submit() {
    var request = [this.data.method, this.data.action, 'HTTP/1.1'].join(' ');
